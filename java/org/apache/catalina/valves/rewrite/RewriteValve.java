        ...
        try {
            ...
            for (int i = 0; i < rules.length; i++) {
                ...
                if (rule.isRedirect() && newtest != null) {
                    ...
                    if (!qsd && queryStringOriginalEncoded != null && queryStringOriginalEncoded.length() > 0) {
            ...
            if (rewritten) {
                if (!done) {
                    ...
                    urlStringRewriteEncoded = RequestUtil.normalize(urlStringRewriteDecoded);
                    ...
                    chunk.append(urlStringRewriteEncoded);
                    if (queryStringRewriteEncoded == null) {
                        ...
                        if (qsa && queryStringOriginalEncoded != null && queryStringOriginalEncoded.length() > 0) {
                            chunk.append('&');
